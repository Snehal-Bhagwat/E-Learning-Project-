...
formatter.match({
  "location": "signupdefination.the_title_and_file_extension_should_be_visible()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "signupdefination.user_clicks_on_button_upload()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "signupdefination.user_can_be_able_to_upload_file()"
});
formatter.result({
  "status": "skipped"
});
